mob/Login()
	var/main_menu_html = file2text("html/GURPS.html")
	//usr << browse_rsc(new/icon('icons/interface.dmi', "space"), "test.jpg")
	//usr << browse({"<img src="character2.jpg">"})
	usr << browse_rsc('main_background.jpg', "main_background.jpg")
	usr << browse_rsc(new/icon('icons/interface.dmi', "character_add"), 	"character1.jpg")
	usr << browse_rsc(new/icon('icons/interface.dmi', "space"), 	"character2.jpg")
	usr << browse_rsc(new/icon('icons/interface.dmi', "character_rip"), 	"character3.jpg")
